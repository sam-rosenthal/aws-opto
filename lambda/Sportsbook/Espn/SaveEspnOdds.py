import os, io, boto3, pytz, json, Sportsbook.Espn.EspnUtil as util, pandas as pd
...
def handler(event, context):
  ...
  sport = event['Sport']  
  if sport == "NCAAB":
    sport = "NCAAB Championship"
  oddsData = util.EspnScraper(sport).getOdds()
  updatedFiles = {}
